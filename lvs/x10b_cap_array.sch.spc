** sch_path: /home/gils/aic/Biomedical_10b_Time_SAR_ADC/xschem/x10b_cap_array.sch
.subckt x10b_cap_array sw[0] sw[1] sw[2] sw[3] sw[4] sw[5] sw[6] sw[7] sw[8] sw[9] vcm vc
