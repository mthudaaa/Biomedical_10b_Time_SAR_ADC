...
C {devices/lab_wire.sym} 220 -490 0 0 {name=p7 sig_type=std_logic lab=clkb0}
C {devices/lab_wire.sym} 220 -470 0 0 {name=p8 sig_type=std_logic lab=clk0}
...
C {devices/lab_wire.sym} 220 -350 0 0 {name=p11 sig_type=std_logic lab=clk1}
C {devices/lab_wire.sym} 220 -330 0 0 {name=p12 sig_type=std_logic lab=clkb1}
...
C {devices/lab_wire.sym} 560 -430 0 1 {name=p22 sig_type=std_logic lab=dac_out}
