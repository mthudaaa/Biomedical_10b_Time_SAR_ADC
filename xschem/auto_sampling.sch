...
C {devices/noconn.sym} 420 -250 0 1 {name=l1}
C {devices/noconn.sym} 700 -250 0 1 {name=l2}
C {devices/noconn.sym} 980 -250 0 1 {name=l3}
...
C {devices/noconn.sym} 1260 -250 0 1 {name=l5}
C {devices/lab_wire.sym} 1360 -270 0 0 {name=p12 sig_type=std_logic lab=CKC}
C {sky130_stdcells/dfrbp_2.sym} 1730 -250 0 0 {name=x11 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
...
C {devices/noconn.sym} 1820 -270 0 1 {name=l8}
C {devices/noconn.sym} 1540 -250 0 1 {name=l11}
C {devices/lab_wire.sym} 1820 -250 0 1 {name=p39 sig_type=std_logic lab=TRIG2}
C {devices/lab_wire.sym} 240 -430 0 0 {name=p31 sig_type=std_logic lab=CKC}
C {sky130_stdcells/dfrbp_2.sym} 330 -410 0 0 {name=x12 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 240 -390 0 0 {name=p32 sig_type=std_logic lab=RST}
C {sky130_stdcells/dfrbp_2.sym} 610 -410 0 0 {name=x13 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 520 -390 0 0 {name=p33 sig_type=std_logic lab=RST}
C {sky130_stdcells/dfrbp_2.sym} 890 -410 0 0 {name=x14 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 800 -390 0 0 {name=p34 sig_type=std_logic lab=RST}
C {sky130_stdcells/dfrbp_2.sym} 1170 -410 0 0 {name=x15 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 1080 -390 0 0 {name=p35 sig_type=std_logic lab=RST}
C {devices/noconn.sym} 420 -410 0 1 {name=l6}
C {devices/noconn.sym} 700 -410 0 1 {name=l12}
C {devices/noconn.sym} 980 -410 0 1 {name=l13}
...
C {sky130_stdcells/dfrbp_2.sym} 1450 -410 0 0 {name=x16 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_wire.sym} 1360 -390 0 0 {name=p42 sig_type=std_logic lab=RST}
C {devices/noconn.sym} 1260 -410 0 1 {name=l14}
C {devices/lab_wire.sym} 1360 -430 0 0 {name=p45 sig_type=std_logic lab=CKC}
C {sky130_stdcells/dfrbp_2.sym} 1730 -410 0 0 {name=x21 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
...
C {devices/noconn.sym} 1820 -410 0 1 {name=l19}
C {devices/noconn.sym} 1540 -410 0 1 {name=l20}
